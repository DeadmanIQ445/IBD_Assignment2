...
object TweetStream{
  ...
  def start(spark: SparkConf, sparkSession: SparkSession, flag: String): Unit ={
    ...
    if (flag == "1"){
      modelsPath = "hdfs://namenode:9000/user/weimaraner/models"
      chkpntPath = "hdfs://namenode:9000/user/weimaraner/chkpnt"
      outputPath = "hdfs://namenode:9000/user/weimaraner/output"
